...
@section('content_header')
    <h1><b>Listado de paralelos académicos</b></h1>
    <hr>
@stop
            ...
            <div class="card card-outline card-primary">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        ...
                        <a href="{{ route('admin.paralelos.index') }}" class="btn btn-default btn-sm">Ver activos</a>
                        <a href="{{ route('admin.paralelos.papelera') }}" class="btn btn-warning btn-sm">Ver papelera</a>
                                ...
                                <div class="modal-content">
                                    <form action="{{ route('admin.paralelos.store') }}" method="POST">
                                        ...
                                        <div class="modal-header bg-primary text-white">
                                            <h5 class="modal-title">Registro de nuevo paralelo</h5>
                            ...
                            @foreach ($paralelos as $paralelo)
                                <tr>
                                    ...
                                    <td class="d-flex justify-content-center">
                                        @if ($paralelo->trashed())
                                            {{-- Botón Restaurar --}}
                                            <form action="{{ route('admin.paralelos.restaurar', $paralelo->id) }}"
                                                method="POST">
                                                @csrf
                                        ...
                                        @else
                                            ...
                                            <div class="modal fade" id="ModalUpdate{{ $paralelo->id }}" tabindex="-1"
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <form action="{{ route('admin.paralelos.update', $paralelo->id) }}"
                                                            method="POST">
                                                            @csrf @method('PUT')
                                                            ...
                                                            <div class="modal-body">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" name="nombre_update"
                                                                        class="form-control"
                                                                        value="{{ old('nombre_update', $paralelo->nombre) }}"
                                                                        required>
                                                                    @error('nombre_update')
                                                                        <small class="text-danger">{{ $message }}</small>
                                                                    @enderror
                                            ...
                                            <form action="{{ route('admin.paralelos.destroy', $paralelo->id) }}"
...
@section('js')
    <script>
        function confirmarEliminacion(id) {
            Swal.fire({
                title: '¿Está seguro?',
                text: "Esta acción enviará el paralelo a la papelera.",
                icon: 'warning',
